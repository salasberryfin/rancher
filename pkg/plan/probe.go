...
// Probe, HTTPGetAction, and ProbeStatus are defined here as the canonical source of truth.
// The system-agent's pkg/prober package currently defines equivalent types independently;
// the intent is for system-agent to eventually import from this package instead.
